...
pacstrap /mnt base linux linux-firmware grub efibootmgr lvm2 nano vim networkmanager xorg-server xorg-xinit xorg-twm xterm sddm i3 firefox virtualbox git yay
